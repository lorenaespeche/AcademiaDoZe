...
public partial class DashboardListViewModel : BaseViewModel
{
    ...
    private async Task LoadDashboardDataAsync()
    {
        ...
        try
        {
            ...
            try
            {
                logradouros = (await logradourosTask).ToList<object>();
            }
            catch (Exception ex)
            {
            ...
            try
            {
                alunos = (await alunosTask).ToList<object>();
            }
            catch (Exception ex)
            {
            ...
            try
            {
                colaboradores = (await colaboradoresTask).ToList<object>();
            }
            catch (Exception ex)
            {
            ...
            try
            {
                matriculas = (await matriculasTask).ToList<object>();
            }
            catch (Exception ex)
            {
